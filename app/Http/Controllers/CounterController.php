...
//        $VisaTypeOption = '<option value=""></option>';
//        $v_type = $getData_App->Visa_type;
//
//        $visaTypeData = '<option value=""></option>';
//
//        foreach ($visaTypeData as $typeItem){
//            if($typeItem->visa_type == $v_type){
//                $VisaTypeOption .= '<option value="'.$typeItem->visa_type.'" selected>'.$typeItem->visa_type.'</option>';
//            }
//            else{
//                $VisaTypeOption .= '<option value="'.$typeItem->visa_type.'">'.$typeItem->visa_type.'</option>';
//            }
//
//        }
