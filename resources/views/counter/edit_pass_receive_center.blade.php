                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="Sticker_type" value="{{@$readyEditData->Sticker_type}}" id="stikerTypeId" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="service_by" value="{{@$readyEditData->service_by}}" id="serviceById" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
